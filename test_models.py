...
from utils.utils import plot_confusion_matrix, save_result_csv
...
parser.add_argument('modality', type=str, choices=['ALL', 'Audio','RGB', 'Flow', 'RGBDiff', 'RGBDiff2', 'RGBDiffplus'], nargs='+')
...
parser.add_argument('--frame_aggregation', type=str, default='avgpool', choices=['avgpool', 'rnn', 'temconv', 'trn-m', 'none', 'videodg'], help='aggregation of frame features (none if baseline_type is not video)')
...
validate(data_loader, verb_net, criterion, num_class, noun_model=noun_net, val_labels=True)
